...
var ladyWrap = document.querySelector('.js-drill-lady');
var scrollIndicator = document.querySelector('.Index-page-scroll-indicator');
...
var allSkills = document.querySelectorAll('.js--skills-item');
var time = 3000;
var count = 0;
var run = 0;
...
function runSkills(Skills, tick) {
  ...
  var width = skill.act.offsetWidth - skillBG.width < 0 ? 0 : skill.act.offsetWidth - skillBG.width + 5;
  skill.act.classList.add('Skills__Item--active');
  skillBG.el.style.paddingRight = "".concat(width, "px");
  count = Skills.length === count + 1 ? 0 : count + 1;
  run = Skills.length === count + 1 ? run + 1 : run;
  setTimeout(function () {
    runSkills(Skills, tick);
  }, tick);
}
...
require("../components/lazysizes/bg-img-load");

require("../components/home-page/skills");

require("../components/home-page/scrollLady");
...
},{"../components/home-page/scrollLady":1,"../components/home-page/skills":2,"../components/lazysizes/bg-img-load":3,"lazysizes":5}],5:[function(require,module,exports){
